...
class BinsArena(Arena):
    ...
    def __init__(
        ...
        """
        xml_path = os.path.join(os.path.dirname(__file__), 'assets/bin_arena.xml')
...
class BinsArenaNoWall(Arena):
    ...
    def __init__(
        ...
        Args:
            ...
            friction: friction parameters of the table
        """
        xml_path = os.path.join(os.path.dirname(__file__), 'assets/bin_arena_nowall.xml')
        super().__init__(xml_path)
