from hem.robosuite.panda.panda_pick_place import PandaPickPlace
...
class PandaPickDiverseObj(PandaPickPlace):
...
class PandaPickPlaceDiverseTrain(PandaPickDiverseObj):
    """
...
class PandaPickPlaceDiverseTest(PandaPickDiverseObj):
    """
    Easier version of task - place one object into its bin.
    A new object is sampled on every reset.
    """
...
class PandaPickPlacePartialDiverseTrain(PandaPickDiverseObj):
    """
    Easier version of task - place one object into its bin.
    A new object is sampled on every reset.
    """
...
class PandaPickPlacePartialDiverseTest(PandaPickDiverseObj):
    """
    Easier version of task - place one object into its bin.
    A new object is sampled on every reset.
    """
